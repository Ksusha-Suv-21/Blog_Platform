...
/*
 <div className={classes.articlePost}>
        <div className={classes['articlePost__header']}>
          <div className={` ${classesA['article__top']}  ${classes['articlePost__top']}`}>

            <div className={classesA['article__left-side']}>
              
              <div className={classesA['article__title-likes']}>
                <Link  to={`/articles/${article.slug}`}>
                  <h1 className={classesA['article__title']}>{ article.title }</h1>
                </Link>
                <label htmlFor='heart' className={classesA['article__label']}>
                  <input
                    className={classesA['article__checkbox']}
                  ...
                  />
                  <span className={classesA['article__count-chek']}>{article.favoritesCount}</span>
                </label>
              </div>

              <div className={classesA['article__genres']}>
                {article.tagList.map((tag, index) => (
                <span key={index} className={classes['article__genres_tags']}>{tag}</span>
                ))}
              </div>
            </div>

            <div className={classesA['article__right-side']}>
              <div className={classesA['article__autor-date']}>
                <p className={classesA['article__autor']}>{article.author.username}</p>
                <div className={classesA['article__date']}>
                  {new Date(article.createdAt).toLocaleDateString()} 
                </div>
              </div>
              <img
                className={classesA['article__img']}
          ...
          <div className={classesA['article__description']}> 
          {article.description} 
          </div>
        </div>

        <div className={classes['articlePost__body']}>
